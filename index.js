...
/* Görev 1: 
	...
	const final2014_v2 = fifaData.filter((item)=>{return (item.Year == 2014 && item.Stage == "Final")})
	console.log(final2014_v2);

//(a) 2014 Dünya kupası Finali Evsahibi takım ismi (dizide "Home Team Name" anahtarı)
let bir = final2014_v2[0]["Home Team Name"];
console.log(bir);

//(b) 2014 Dünya kupası Finali Deplasman takım ismi  (dizide "Away Team Name" anahtarı)
console.log(final2014_v2[0]["Away Team Name"])
//(c) 2014 Dünya kupası finali Ev sahibi takım golleri (dizide "Home Team Goals" anahtarı)
console.log(final2014_v2[0]["Home Team Goals"])
//(d)2014 Dünya kupası finali Deplasman takım golleri  (dizide "Away Team Goals" anahtarı)
console.log(final2014_v2[0]["Away Team Goals"])
//(e) 2014 Dünya kupası finali kazananı*/
if(final2014_v2[0]["Home Team Goals"] >final2014_v2[0]["Away Team Goals"] ){
	console.log("kazanan " + final2014_v2[0]["Home Team Name"] ) } else { console.log("kazanan"+final2014_v2[0]["Away Team Name"] )}
...
function Yillar(array , callback)  {
	...
	const yillar = finaller.map(item =>{
		return item.Year;
	})
    return yillar ;
}
...
let kazananlar = cb_kazananlar (arr , cb_finaller);
